        ...
        <div class="dev-note-section-header" data-aos="fade-up">
            ...
            <div>
                ...
                <p class="dev-note-section-desc">
                    <code class="dev-code">https://iel.im/</code> 원본 사이트를 Chrome DevTools, Lighthouse, PageSpeed Insights로 직접 분석하여 개선 기회를 도출했습니다.
                </p>
            </div>
        </div>
        ...
        <div class="dev-note-problems-grid">
            ...
            <div class="dev-problem-card" data-aos="fade-up" data-aos-delay="200">
                ...
                <ul class="dev-problem-list">
                    ...
                    <li>
                        <span class="dev-problem-badge bad">문제</span>
                        SNS 공유용 Open Graph 태그 (<code class="dev-code">og:title</code>, <code class="dev-code">og:image</code>) 없음
                    </li>
                    <li>
                        <span class="dev-problem-badge bad">문제</span>
                    ...
                    <li>
                        <span class="dev-problem-badge good">개선</span>
                        OG 태그 + <code class="dev-code">&lt;section&gt;</code>, <code class="dev-code">&lt;article&gt;</code> 시맨틱 구조 정비
                    </li>
                </ul>
            </div>
                ...
                <table class="dev-note-compare-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center highlight-col"><span class="dev-compare-good">PHP 100% 완전 제어</span></td>
                        </tr>
                        <tr>
                            <td><strong>성능</strong></td>
                            <td class="text-center"><span class="dev-compare-bad">CSS/JS 수백 KB 자동 포함</span></td>
                            <td class="text-center highlight-col"><span class="dev-compare-good">필요한 리소스만 선택적 로드</span></td>
                        </tr>
                        <tr>
                            <td><strong>SEO 제어</strong></td>
                            <td class="text-center"><span class="dev-compare-bad">구조화 데이터 주입 제한</span></td>
                            <td class="text-center highlight-col"><span class="dev-compare-good">wp_head() 훅으로 완전 제어</span></td>
                        </tr>
                        <tr>
                            <td><strong>채용 어필</strong></td>
                            <td class="text-center"><span class="dev-compare-neutral">드래그&amp;드롭 역량 증명</span></td>
                            <td class="text-center highlight-col"><span class="dev-compare-good">PHP · JS · CSS 실력 직접 증명</span></td>
                        </tr>
                        <tr>
                            <td><strong>기술 복잡도</strong></td>
                            <td class="text-center"><span class="dev-compare-neutral">코딩 불필요</span></td>
                            <td class="text-center highlight-col"><span class="dev-compare-good">템플릿 계층 · Hook · 바닐라 JS</span></td>
                        </tr>
                        <tr>
                            <td><strong>환경 재현</strong></td>
                            <td class="text-center"><span class="dev-compare-bad">설치·환경 매번 별도 구성</span></td>
                            <td class="text-center highlight-col"><span class="dev-compare-good">Docker — 60초 내 즉시 재현</span></td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="dev-highlight-grid">
            ...
            <div class="dev-highlight-card" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="dev-highlight-content">
                    ...
                    <p>스크롤 전 완전 투명 → 스크롤 후 배경 블러 + 반투명. <code class="dev-code">scrollY</code> 값 감지 후 CSS 클래스 동적 토글. 다크/라이트 모드 각각 별도 처리.</p>
                </div>
            </div>
            ...
            <div class="dev-highlight-card" data-aos="fade-up" data-aos-delay="150">
                ...
                <div class="dev-highlight-content">
                    <h4>인터랙티브 탭 컴포넌트</h4>
                    <p>Communication / Focus / Reasonable 탭 전환 시 텍스트·이미지·프로그레스 바 3가지 요소 동시 연동. <code class="dev-code">requestAnimationFrame</code> 기반 부드러운 바 애니메이션 구현.</p>
                </div>
            </div>
            ...
            <div class="dev-highlight-card" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="dev-highlight-content">
                    <h4>깜빡임 없는 다크모드</h4>
                    <p><code class="dev-code">localStorage</code> + 시스템 설정(<code class="dev-code">prefers-color-scheme</code>) 감지. 페이지 로드 즉시 실행되는 인라인 IIFE 스크립트로 FOUC(깜빡임) 완전 방지.</p>
                </div>
            </div>
            ...
            <div class="dev-highlight-card" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="dev-highlight-content">
                    <h4>페이지 자동 생성 시스템</h4>
                    <p>WordPress 활성화 시 <code class="dev-code">init</code> 훅으로 필요한 모든 페이지가 자동 생성. 슬러그 기반 템플릿 자동 연결. 개발자 없이도 즉시 사용 가능한 구조 설계.</p>
                </div>
            </div>
            ...
            <div class="dev-highlight-card" data-aos="fade-up" data-aos-delay="350">
                ...
                <div class="dev-highlight-content">
                    <h4>포트폴리오 안내 배너</h4>
                    <p>채용 담당자가 사이트 목적을 즉시 파악할 수 있도록 최상단에 고정 배너 구현. <code class="dev-code">localStorage</code>로 닫힌 상태 영속화. CSS 변수로 GNB 위치 동적 조정.</p>
                </div>
            </div>
...
.dev-tag-php    { background: rgba(79,70,229,0.2);  color: #a5b4fc; border: 1px solid rgba(79,70,229,0.3); }
.dev-tag-wp     { background: rgba(33,117,155,0.2); color: #7dd3fc; border: 1px solid rgba(33,117,155,0.3); }
.dev-tag-tw     { background: rgba(14,165,233,0.2); color: #7dd3fc; border: 1px solid rgba(14,165,233,0.3); }
.dev-tag-js     { background: rgba(245,158,11,0.2); color: #fcd34d; border: 1px solid rgba(245,158,11,0.3); }
.dev-tag-docker { background: rgba(36,150,237,0.2); color: #7dd3fc; border: 1px solid rgba(36,150,237,0.3); }
.dev-tag-git    { background: rgba(240,80,50,0.2);  color: #fca5a5; border: 1px solid rgba(240,80,50,0.3); }
...
@keyframes wheelScroll  { 0%,100%{transform:translateY(0);opacity:1} 70%{transform:translateY(8px);opacity:0} }
...
.dev-note-tab-nav-inner::-webkit-scrollbar { display: none; }
.dev-note-tab {
    display: flex;
    align-items: center;
    gap: 10px;
...
.dev-note-tab:hover { color: #006eff; }
.dev-note-tab.active { color: #006eff; border-bottom-color: #006eff; }
.dev-note-tab-num {
    font-size: 11px;
    font-weight: 700;
    color: #006eff;
...
/* ---- 섹션 공통 ---- */
.dev-note-section { padding: 96px 0; }
.dev-note-section-alt { background: #f8faff; }
html.dark .dev-note-section-alt { background: #0d1117; }
...
html.dark .dev-note-section-title { color: #f3f4f6; }
...
@media (max-width: 767px) {
    .dev-note-problems-grid { grid-template-columns: 1fr; }
}
...
.dev-problem-card:hover { transform: translateY(-3px); box-shadow: 0 12px 40px rgba(0,0,0,0.1); }
html.dark .dev-problem-card { background: #111827; border-color: rgba(255,255,255,0.08); }
...
html.dark .dev-problem-title { color: #f3f4f6; }
...
html.dark .dev-problem-list li { color: #9ca3af; }
...
.dev-problem-badge.bad  { background: rgba(239,68,68,0.1);  color: #ef4444; }
.dev-problem-badge.good { background: rgba(16,185,129,0.1); color: #10b981; }
...
html.dark .dev-note-compare-wrap { background: #111827; border-color: rgba(255,255,255,0.08); }
.dev-note-compare-header { padding: 24px 28px 0; }
.dev-note-compare-vs { display: flex; align-items: center; gap: 16px; flex-wrap: wrap; }
.dev-compare-label {
    font-size: 14px;
    font-weight: 700;
    font-family: 'Pretendard', sans-serif;
...
.dev-compare-label.elementor { background: rgba(239,68,68,0.1); color: #ef4444; }
.dev-compare-label.custom    { background: rgba(0,110,255,0.1); color: #006eff; }
.dev-compare-vs-text { font-size: 14px; color: #9ca3af; font-weight: 600; font-family: 'Inter', sans-serif; }

.dev-note-compare-table-wrap { overflow-x: auto; padding: 0 8px 8px; }
.dev-note-compare-table { width: 100%; border-collapse: collapse; font-family: 'Pretendard', sans-serif; font-size: 14px; }
...
html.dark .dev-note-compare-table td { color: #9ca3af; }
html.dark .dev-note-compare-table th { border-bottom-color: rgba(255,255,255,0.06); }
html.dark .dev-note-compare-table td { border-bottom-color: rgba(255,255,255,0.04); }
.dev-note-compare-table .highlight-col { background: rgba(0,110,255,0.03); }
.dev-compare-good    { color: #10b981; font-weight: 700; }
.dev-compare-bad     { color: #ef4444; }
.dev-compare-neutral { color: #6b7280; }
...
html.dark .dev-reason-card { background: #111827; border-color: rgba(255,255,255,0.08); }
.dev-reason-emoji { font-size: 32px; margin-bottom: 16px; }
.dev-reason-title {
    font-family: 'Pretendard', sans-serif;
    font-size: 18px;
    font-weight: 800;
...
html.dark .dev-reason-title { color: #f3f4f6; }
.dev-reason-list {
    list-style: none;
    padding: 0; margin: 0;
...
.dev-reason-list li::before { content: '▸'; position: absolute; left: 0; color: #006eff; }
html.dark .dev-reason-list li { color: #9ca3af; }
.dev-reason-code {
    background: #0d1117;
    border-radius: 12px;
    padding: 16px 20px;
...
.dev-reason-code-line { color: #e2e8f0; }
.dev-code-comment { color: #6b7280; font-style: italic; }
.dev-code-cmd { color: #10b981; }
.dev-reason-note { font-family: 'Pretendard', sans-serif; font-size: 13px; color: #6b7280; line-height: 1.6; }

/* ---- 기술 스택 ---- */
.dev-stack-grid { display: flex; flex-direction: column; gap: 40px; margin-bottom: 64px; }
...
html.dark .dev-stack-group-title { color: #f3f4f6; }
.dev-stack-cards { display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: 16px; }
.dev-stack-card {
    display: flex;
    align-items: flex-start;
    gap: 16px;
...
.dev-stack-card:hover { transform: translateY(-2px); box-shadow: 0 8px 24px rgba(0,0,0,0.08); }
html.dark .dev-stack-card { background: #111827; border-color: rgba(255,255,255,0.08); }
.dev-stack-icon {
...
.dev-stack-info { display: flex; flex-direction: column; gap: 4px; }
...
html.dark .dev-stack-info strong { color: #f3f4f6; }
.dev-stack-info span {
    font-family: 'Pretendard', sans-serif;
    font-size: 13px;
    color: #6b7280;
...
html.dark .dev-highlight-title { color: #f3f4f6; }
.dev-highlight-grid {
    display: grid;
...
@media (max-width: 767px) { .dev-highlight-grid { grid-template-columns: 1fr; } }
.dev-highlight-card {
    display: flex;
    gap: 18px;
    background: #fff;
...
.dev-highlight-card:hover { transform: translateY(-2px); box-shadow: 0 8px 24px rgba(0,0,0,0.08); }
html.dark .dev-highlight-card { background: #111827; border-color: rgba(255,255,255,0.08); }
.dev-highlight-num {
    font-size: 28px;
    font-weight: 900;
    font-family: 'Lora', serif;
...
html.dark .dev-highlight-content h4 { color: #f3f4f6; }
...
html.dark .dev-code { background: rgba(0,110,255,0.15); color: #93c5fd; }
...
.dev-metric-label small { font-size: 12px; color: rgba(255,255,255,0.5); display: block; margin-top: 2px; }
.dev-metric-compare {
    font-family: 'Pretendard', sans-serif;
    font-size: 12px;
    color: #10b981;
...
html.dark .dev-note-cta { background: linear-gradient(135deg, #0d1b3e, #111827); border-color: rgba(0,110,255,0.2); }
.dev-note-cta-text {
    font-family: 'Pretendard', sans-serif;
    font-size: 18px;
    color: #374151;
...
html.dark .dev-note-cta-text { color: #9ca3af; }
.dev-note-cta-buttons { display: flex; justify-content: center; gap: 16px; flex-wrap: wrap; }
.dev-cta-btn {
    display: inline-flex;
    align-items: center;
    gap: 8px;
...
.dev-cta-btn-primary { background: #006eff; color: #fff; }
.dev-cta-btn-primary:hover { background: #0055cc; transform: translateY(-2px); box-shadow: 0 8px 24px rgba(0,110,255,0.3); }
.dev-cta-btn-outline { background: #fff; color: #374151; border: 1.5px solid rgba(0,0,0,0.12); }
.dev-cta-btn-outline:hover { background: #f9fafb; transform: translateY(-2px); box-shadow: 0 8px 24px rgba(0,0,0,0.08); }
html.dark .dev-cta-btn-outline { background: #1f2937; color: #f3f4f6; border-color: rgba(255,255,255,0.1); }
</style>
