...
<!-- 포스트 히어로 헤더 -->
<section class="relative pt-[120px] lg:pt-[180px] pb-[50px] lg:pb-[80px] bg-white overflow-hidden border-b border-gray-100">
    <div class="max-w-[860px] mx-auto px-5 lg:px-10">
        <!-- 뒤로가기 & 카테고리 -->
        <div class="flex items-center gap-3 mb-8" data-aos="fade-up">
            <a href="javascript:history.back()"
               class="inline-flex items-center gap-1.5 text-[#006eff] font-pretendard text-[14px] font-medium hover:underline">
            ...
            ?>
                ...
                <span class="font-pretendard text-[13px] font-semibold text-[#006eff] uppercase tracking-wider">
        ...
        <?php while (have_posts()) : the_post(); ?>
            ...
            <!-- 포스트 제목 -->
            <h1 class="font-pretendard text-[24px] lg:text-[40px] font-bold text-[#1a1a1a] leading-snug tracking-tight mb-6" data-aos="fade-up">
                <?php the_title(); ?>
            </h1>

            <!-- 메타 정보 바 -->
            <div class="flex flex-wrap items-center gap-4 text-[14px] text-gray-400 font-pretendard font-light pb-8 border-b border-gray-100" data-aos="fade-up">
                <!-- 작성일 -->
    ...
    <div class="max-w-[860px] mx-auto px-5 lg:px-10">
        <div class="bg-gray-50 border border-gray-200 rounded-2xl p-6 lg:p-8">
            <p class="font-pretendard text-[13px] lg:text-[14px] text-gray-400 font-light leading-relaxed">
                ...
                본 게시물에 기재된 내용은 일반적인 법률 정보 제공을 목적으로 하며, 구체적인 법률적 자문이나 의견을 구성하지 않습니다. 개별 사건의 사실 관계에 따라 법리가 달리 적용될 수 있으므로, 구체적인 법률 자문을 위해서는 반드시 담당 변호사와 직접 상담하시기 바랍니다.
            </p>
        </div>
    </div>
</section>
                ...
                <a href="<?php the_permalink(); ?>"
                   class="group bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                    ...
                    <div class="p-5">
                        ...
                        <h3 class="font-pretendard text-[15px] font-semibold text-[#1a1a1a] leading-snug group-hover:text-[#006eff] transition-colors line-clamp-2">
                            <?php the_title(); ?>
                        </h3>
                    </div>
                </a>
