    ...
    <div class="relative z-10 max-w-[1520px] mx-auto px-5 lg:px-10">
        <div class="max-w-[800px]" data-aos="fade-up" data-aos-duration="1000">
            ...
            <p class="font-pretendard text-[16px] lg:text-[19px] font-light text-gray-300 leading-relaxed">
                당신의 고민을 편안하게 털어놓으세요. 이엘의 전문 변호인단이 직접 검토합니다.
            </p>
        </div>
    </div>
</section>
        ...
        <div class="w-full lg:w-[480px] shrink-0" data-aos="fade-left">
            ...
            (function() {
                ...
                var infowindow = new kakao.maps.InfoWindow({
                    content: '<div style="padding:10px 14px;font-family:Pretendard,sans-serif;font-size:13px;font-weight:600;color:#1a1a1a;white-space:nowrap;line-height:1.5;">법무법인 이엘<br><span style="font-weight:400;color:#6d6d6d;font-size:12px;">강남구 테헤란로 110, 15층</span></div>',
                    removable: false
                });
            ...
            <div class="space-y-6 font-pretendard text-[15px]">
                ...
                <div>
                    ...
                    <p class="text-gray-500 font-light leading-relaxed">서울특별시 강남구 테헤란로 110 (역삼동, 이엘타워) 15층</p>
                </div>
                <!-- 연락처 -->
                <div>
                    <h4 class="font-bold text-[#1a1a1a] mb-1">전화 및 이메일</h4>
                    <p class="text-gray-500 font-light font-inter">Tel. 02-872-1307</p>
                    <p class="text-gray-500 font-light font-inter">Email. iel@iel.im</p>
                </div>
                <!-- 지하철 -->
                <div>
                    <h4 class="font-bold text-[#1a1a1a] mb-1">지하철 이용 시</h4>
                    <p class="text-gray-500 font-light leading-relaxed">
                        <span class="text-green-600 font-medium">2호선</span> / <span class="text-rose-700 font-medium">신분당선</span> 강남역 6번 출구로 나오셔서 전방 50m 직진, 좌측 이엘타워로 진입하십시오.
                    </p>
                </div>
                <!-- 주차 -->
                <div>
