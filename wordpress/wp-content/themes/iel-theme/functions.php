<?php
/**
 * IEL Theme functions and definitions
 */
...
function iel_seo_meta_tags() {
    ...
    $description = '법무법인 이엘은 검사 출신 성범죄 전문 변호인단이 직접 사건을 수행하며 의뢰인의 일상을 지킵니다.';
    ...
    echo '<meta property="og:site_name" content="법무법인 이엘">' . "\n";
...
function iel_theme_scripts() {
    ...
    wp_enqueue_style('iel-style', get_stylesheet_uri(), array(), '1.0.0');
