...
<footer class="bg-[#111111] text-white font-pretendard border-t border-white/5">
    ...
    <div class="max-w-[1520px] mx-auto px-5 lg:px-10 py-16 lg:py-24">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            ...
            <div class="lg:col-span-1 flex flex-col gap-5">
                ...
                <div class="text-[13px] text-[#6d6d6d] leading-relaxed space-y-1.5 font-light border-t border-white/5 pt-5">
            ...
            <div class="flex flex-col gap-5">
                ...
                <ul class="space-y-3 text-[14px] text-[#9d9d9d] font-light">
                    <li><a href="<?php echo esc_url(home_url('/practice-areas/')); ?>" class="hover:text-white transition-colors duration-200">성범죄 · 강력 형사 전담</a></li>
                    <li><a href="<?php echo esc_url(home_url('/practice-areas/')); ?>" class="hover:text-white transition-colors duration-200">피해자 보호 · 고소 대리</a></li>
                    <li><a href="<?php echo esc_url(home_url('/practice-areas/')); ?>" class="hover:text-white transition-colors duration-200">개인회생 · 파산 전담</a></li>
                    <li><a href="<?php echo esc_url(home_url('/practice-areas/')); ?>" class="hover:text-white transition-colors duration-200">민사 · 가사 · 상속 분쟁</a></li>
                </ul>
            </div>
            ...
            <div class="flex flex-col gap-5">
                ...
                <ul class="space-y-3 text-[14px] text-[#9d9d9d] font-light">
                    <li><a href="<?php echo esc_url(home_url('/about/')); ?>" class="hover:text-white transition-colors duration-200">법인 소개</a></li>
                    <li><a href="<?php echo esc_url(home_url('/news/')); ?>" class="hover:text-white transition-colors duration-200">뉴스</a></li>
                    <li><a href="<?php echo esc_url(home_url('/insight/')); ?>" class="hover:text-white transition-colors duration-200">법률 인사이트</a></li>
                    <li><a href="<?php echo esc_url(home_url('/careers/')); ?>" class="hover:text-white transition-colors duration-200">인재 채용</a></li>
                </ul>
            </div>
    ...
    <div class="border-t border-white/5">
        <div class="max-w-[1520px] mx-auto px-5 lg:px-10 py-5 flex flex-col md:flex-row items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-6 text-[13px] text-[#4d4d4d]">
                ...
                <a href="#" class="hover:text-white font-semibold transition-colors duration-200 text-[#6d6d6d]">개인정보처리방침</a>
                <a href="<?php echo esc_url(home_url('/contact/')); ?>" class="hover:text-white transition-colors duration-200">찾아오시는 길</a>
            </div>
        </div>
    </div>
...
<!-- ============================================
     플로팅 상담 버튼 (모든 페이지 공통)
     ============================================ -->
<div id="float-consult-wrap" style="position:fixed;bottom:28px;right:28px;z-index:9999;display:flex;flex-direction:column;align-items:flex-end;gap:12px;">

    <!-- 채널 선택 팝업 (기본 숨김) -->
    <div id="float-consult-menu"
        ...
        <!-- 카카오톡 채널 -->
        <a href="http://pf.kakao.com/_INxeeT" target="_blank" rel="noopener"
           id="float-kakao"
           ...
           onmouseout="this.style.transform='scale(1)';this.style.boxShadow='0 4px 20px rgba(0,0,0,0.12)';">
            ...
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 3C6.477 3 2 6.82 2 11.5c0 2.91 1.67 5.48 4.22 7.09L5 21l3.6-1.8C9.5 19.38 10.73 19.5 12 19.5c5.523 0 10-3.82 10-8.5S17.523 3 12 3z" fill="#1a1a1a"/>
            </svg>
            카카오톡 상담
        </a>
    ...
    <button id="float-consult-btn"
        ...
        <!-- X 아이콘 (팝업 열렸을 때) -->
        <svg id="float-icon-close" width="24" height="24" fill="none" stroke="#fff" stroke-width="2.5" viewBox="0 0 24 24"
