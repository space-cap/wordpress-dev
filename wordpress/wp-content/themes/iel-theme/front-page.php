...
<section class="py-24 lg:py-36 bg-[#f8fafe] overflow-hidden">
    <div class="max-w-[1520px] mx-auto px-5 lg:px-10">
        <div class="text-center mb-16 lg:mb-24" data-aos="fade-up">
            <span class="text-[#006eff] font-inter text-[13px] lg:text-[15px] font-bold tracking-wider uppercase">PRACTICE AREAS</span>
            <h2 class="font-pretendard text-[28px] lg:text-[44px] font-bold text-[#1a1a1a] tracking-tight mt-3">
                분야별 최고 전문가들의 정밀한 해결책
            </h2>
            <p class="font-pretendard text-gray-500 text-[15px] lg:text-[18px] mt-4 max-w-[700px] mx-auto leading-relaxed">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            <!-- 1. 성범죄/강력형사 -->
            <div class="bg-white border border-gray-100 rounded-[32px] p-8 lg:p-12 hover:shadow-2xl hover:shadow-[#006eff]/5 hover:border-[#006eff]/20 transition-all duration-300 group flex flex-col justify-between" data-aos="fade-up">
                <div>
                    <div class="flex items-start justify-between mb-8">
                        <div class="w-14 h-14 bg-[#f4f8ff] rounded-2xl flex items-center justify-center group-hover:bg-[#006eff] transition-colors duration-300">
                            <svg class="w-7 h-7 text-[#006eff] group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"></path></svg>
                        </div>
                        <span class="font-inter text-gray-200 font-bold text-[32px] lg:text-[40px] group-hover:text-[#006eff]/20 transition-colors">01</span>
                    </div>
                    <h3 class="font-pretendard text-[22px] lg:text-[26px] font-bold text-[#1a1a1a] mb-4">성범죄 · 강력 형사 전담 센터</h3>
                ...
                <a href="<?php echo esc_url(home_url('/practice-areas/')); ?>" class="inline-flex items-center text-[#006eff] font-semibold text-[15px] hover:underline gap-1.5 mt-4">
                    자세히 보기
            ...
            <!-- 2. 피해자 보호/고소 대리 -->
            <div class="bg-white border border-gray-100 rounded-[32px] p-8 lg:p-12 hover:shadow-2xl hover:shadow-[#006eff]/5 hover:border-[#006eff]/20 transition-all duration-300 group flex flex-col justify-between" data-aos="fade-up" data-aos-delay="100">
                <div>
                    <div class="flex items-start justify-between mb-8">
                        <div class="w-14 h-14 bg-[#f4f8ff] rounded-2xl flex items-center justify-center group-hover:bg-[#006eff] transition-colors duration-300">
                            <svg class="w-7 h-7 text-[#006eff] group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
                        </div>
                        <span class="font-inter text-gray-200 font-bold text-[32px] lg:text-[40px] group-hover:text-[#006eff]/20 transition-colors">02</span>
                    </div>
                    <h3 class="font-pretendard text-[22px] lg:text-[26px] font-bold text-[#1a1a1a] mb-4">피해자 보호 · 고소 대리</h3>
                    <p class="font-pretendard text-gray-500 text-[15px] lg:text-[16px] leading-relaxed mb-6 font-light">
            ...
            <!-- 3. 개인회생/파산 -->
            <div class="bg-white border border-gray-100 rounded-[32px] p-8 lg:p-12 hover:shadow-2xl hover:shadow-[#006eff]/5 hover:border-[#006eff]/20 transition-all duration-300 group flex flex-col justify-between" data-aos="fade-up" data-aos-delay="200">
                <div>
                    <div class="flex items-start justify-between mb-8">
                        <div class="w-14 h-14 bg-[#f4f8ff] rounded-2xl flex items-center justify-center group-hover:bg-[#006eff] transition-colors duration-300">
                            <svg class="w-7 h-7 text-[#006eff] group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        </div>
                        <span class="font-inter text-gray-200 font-bold text-[32px] lg:text-[40px] group-hover:text-[#006eff]/20 transition-colors">03</span>
                    </div>
                    <h3 class="font-pretendard text-[22px] lg:text-[26px] font-bold text-[#1a1a1a] mb-4">개인회생 · 파산 전담 센터</h3>
                    <p class="font-pretendard text-gray-500 text-[15px] lg:text-[16px] leading-relaxed mb-6 font-light">
            ...
            <!-- 4. 민사/가사/상속 -->
            <div class="bg-white border border-gray-100 rounded-[32px] p-8 lg:p-12 hover:shadow-2xl hover:shadow-[#006eff]/5 hover:border-[#006eff]/20 transition-all duration-300 group flex flex-col justify-between" data-aos="fade-up" data-aos-delay="300">
                <div>
                    <div class="flex items-start justify-between mb-8">
                        <div class="w-14 h-14 bg-[#f4f8ff] rounded-2xl flex items-center justify-center group-hover:bg-[#006eff] transition-colors duration-300">
                            <svg class="w-7 h-7 text-[#006eff] group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                        </div>
                        <span class="font-inter text-gray-200 font-bold text-[32px] lg:text-[40px] group-hover:text-[#006eff]/20 transition-colors">04</span>
                    </div>
                    <h3 class="font-pretendard text-[22px] lg:text-[26px] font-bold text-[#1a1a1a] mb-4">민사 · 가사 · 상속 분쟁</h3>
                    <p class="font-pretendard text-gray-500 text-[15px] lg:text-[16px] leading-relaxed mb-6 font-light">
...
<section class="py-24 lg:py-32 bg-[#0c1020] text-white relative overflow-hidden">
    <!-- 미세한 배경 광채 효과 -->
    <div class="absolute top-[-20%] left-[-10%] w-[50%] h-[60%] rounded-full bg-[#006eff]/10 blur-[150px] pointer-events-none"></div>
    <div class="absolute bottom-[-20%] right-[-10%] w-[50%] h-[60%] rounded-full bg-[#0047cc]/10 blur-[150px] pointer-events-none"></div>

    <div class="relative z-10 max-w-[1520px] mx-auto px-5 lg:px-10">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            
            <div class="lg:col-span-4" data-aos="fade-right">
                <span class="text-[#006eff] font-inter text-[13px] lg:text-[15px] font-bold tracking-wider uppercase">BY THE NUMBERS</span>
            ...
            <div class="lg:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8">
                ...
                <!-- 지표 1 -->
                <div class="bg-white/5 border border-white/10 rounded-2xl p-6 lg:p-8 text-center backdrop-blur-sm hover:border-[#006eff]/50 transition-all duration-300" data-aos="fade-up" data-aos-delay="100">
                    <span class="block font-inter text-[36px] lg:text-[48px] font-extrabold text-[#006eff]">95.8%</span>
                    <span class="block font-pretendard text-gray-300 text-[14px] lg:text-[16px] font-medium mt-2">승소 및 성공 사례</span>
                </div>

                <!-- 지표 2 -->
                <div class="bg-white/5 border border-white/10 rounded-2xl p-6 lg:p-8 text-center backdrop-blur-sm hover:border-[#006eff]/50 transition-all duration-300" data-aos="fade-up" data-aos-delay="200">
                    <span class="block font-inter text-[36px] lg:text-[48px] font-extrabold text-white">3,200+</span>
                    <span class="block font-pretendard text-gray-300 text-[14px] lg:text-[16px] font-medium mt-2">누적 해결 사건</span>
                </div>

                <!-- 지표 3 -->
                <div class="bg-white/5 border border-white/10 rounded-2xl p-6 lg:p-8 text-center backdrop-blur-sm hover:border-[#006eff]/50 transition-all duration-300" data-aos="fade-up" data-aos-delay="300">
                    <span class="block font-inter text-[36px] lg:text-[48px] font-extrabold text-white">24명</span>
                    <span class="block font-pretendard text-gray-300 text-[14px] lg:text-[16px] font-medium mt-2">전문 자문위원단</span>
                </div>

                <!-- 지표 4 -->
                <div class="bg-white/5 border border-white/10 rounded-2xl p-6 lg:p-8 text-center backdrop-blur-sm hover:border-[#006eff]/50 transition-all duration-300" data-aos="fade-up" data-aos-delay="400">
                    <span class="block font-inter text-[36px] lg:text-[48px] font-extrabold text-[#006eff]">24h</span>
                    <span class="block font-pretendard text-gray-300 text-[14px] lg:text-[16px] font-medium mt-2">긴급 대응 체계</span>
                </div>
    ...
    <div class="max-w-[1520px] mx-auto px-5 lg:px-10">
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-16 lg:mb-24" data-aos="fade-up">
            <div>
                ...
                <h2 class="font-pretendard text-[28px] lg:text-[44px] font-bold text-[#1a1a1a] tracking-tight mt-2">최고의 법률 드림팀을 소개합니다</h2>
            </div>
            <p class="font-pretendard text-gray-500 max-w-[450px] mt-4 lg:mt-0 text-[15px] lg:text-[17px] leading-relaxed font-light">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <!-- 변호사 1 -->
            <div class="bg-gray-50 rounded-[32px] overflow-hidden hover:shadow-2xl hover:shadow-[#006eff]/5 transition-all duration-300 group border border-gray-100" data-aos="fade-up" data-aos-delay="100">
                <div class="h-[380px] lg:h-[450px] overflow-hidden relative">
                    <img src="https://images.pexels.com/photos/5668772/pexels-photo-5668772.jpeg" alt="이영현 대표변호사" loading="lazy" class="w-full h-full object-cover object-top transition-transform duration-500 group-hover:scale-105">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/75 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-8">
                        <p class="text-white text-[14px] lg:text-[15px] font-light leading-relaxed mb-4">"의뢰인이 겪고 있는 고통의 크기가 곧 우리가 집중해야 할 문제의 무게입니다."</p>
                        <span class="text-white/60 text-[13px] font-light">성범죄 · 강력 형사 센터장 / 前 부부장검사</span>
                    </div>
                </div>
                <div class="p-8 bg-white border-t border-gray-50">
                    <span class="text-[#006eff] text-[13px] lg:text-[14px] font-bold uppercase tracking-wider">Representative Attorney</span>
                    <h3 class="font-pretendard text-[22px] lg:text-[26px] font-bold text-[#1a1a1a] mt-1">이영현 대표변호사</h3>
                </div>
            </div>

            <!-- 변호사 2 -->
            <div class="bg-gray-50 rounded-[32px] overflow-hidden hover:shadow-2xl hover:shadow-[#006eff]/5 transition-all duration-300 group border border-gray-100" data-aos="fade-up" data-aos-delay="200">
                <div class="h-[380px] lg:h-[450px] overflow-hidden relative">
                    <img src="https://images.pexels.com/photos/5668858/pexels-photo-5668858.jpeg" alt="박민서 파트너변호사" loading="lazy" class="w-full h-full object-cover object-top transition-transform duration-500 group-hover:scale-105">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/75 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-8">
                        <p class="text-white text-[14px] lg:text-[15px] font-light leading-relaxed mb-4">"법리는 오차 없이 정밀하게 검토하고, 변론은 따뜻한 공감을 바탕으로 의뢰인의 편에서 펼치겠습니다."</p>
                        <span class="text-white/60 text-[13px] font-light">개인회생 · 파산 센터장 / 대한변협 등록 변호사</span>
                    </div>
                </div>
                <div class="p-8 bg-white border-t border-gray-50">
                    <span class="text-[#006eff] text-[13px] lg:text-[14px] font-bold uppercase tracking-wider">Partner Attorney</span>
                    <h3 class="font-pretendard text-[22px] lg:text-[26px] font-bold text-[#1a1a1a] mt-1">박민서 파트너변호사</h3>
                </div>
            </div>

            <!-- 변호사 3 -->
            <div class="bg-gray-50 rounded-[32px] overflow-hidden hover:shadow-2xl hover:shadow-[#006eff]/5 transition-all duration-300 group border border-gray-100" data-aos="fade-up" data-aos-delay="300">
                <div class="h-[380px] lg:h-[450px] overflow-hidden relative">
                    <img src="https://images.pexels.com/photos/6077368/pexels-photo-6077368.jpeg" alt="김우진 소송전담변호사" loading="lazy" class="w-full h-full object-cover object-top transition-transform duration-500 group-hover:scale-105">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/75 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-8">
                        <p class="text-white text-[14px] lg:text-[15px] font-light leading-relaxed mb-4">"사건 현장의 작은 흔적조차 결정적인 증거가 될 수 있습니다. 현장형 정밀 조사를 약속합니다."</p>
                        <span class="text-white/60 text-[13px] font-light">민사 · 가사 소송 전담 / 前 대형 로펌 시니어 변호사</span>
                    </div>
                </div>
                <div class="p-8 bg-white border-t border-gray-50">
                    <span class="text-[#006eff] text-[13px] lg:text-[14px] font-bold uppercase tracking-wider">Senior Associate Attorney</span>
...
<section class="py-24 lg:py-36 bg-[#fcfcfc] border-t border-gray-100 overflow-hidden">
    <div class="max-w-[1520px] mx-auto px-5 lg:px-10">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 lg:mb-24" data-aos="fade-up">
            <div>
                <span class="text-[#006eff] font-inter text-[13px] lg:text-[15px] font-bold tracking-wider uppercase">INSIGHTS & NEWS</span>
                <h2 class="font-pretendard text-[28px] lg:text-[44px] font-bold text-[#1a1a1a] tracking-tight mt-2">이엘의 법률 가이드 & 뉴스</h2>
            </div>
            <a href="<?php echo esc_url(home_url('/insight/')); ?>" class="group inline-flex items-center gap-1.5 text-gray-500 hover:text-[#006eff] transition-colors mt-4 md:mt-0 font-medium">
                전체 소식 보기
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            if ($query->have_posts()) :
                while ($query->have_posts()) : $query->the_post();
                    ...
                    ?>
                    <!-- 동적 카드 -->
                    <article class="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 flex flex-col justify-between" data-aos="fade-up">
                        ...
                        <div class="p-8 flex-1 flex flex-col justify-between">
                            <div>
                                ...
                                <h3 class="font-pretendard text-[18px] lg:text-[21px] font-bold text-[#1a1a1a] mt-2 mb-3 line-clamp-2 hover:text-[#006eff] transition-colors">
                                    <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                                </h3>
                                <p class="font-pretendard text-gray-500 text-[14px] lg:text-[15px] font-light leading-relaxed line-clamp-3 mb-6">
                                    <?php echo esc_html(wp_strip_all_tags(get_the_excerpt())); ?>
                                </p>
                            </div>
                            <span class="block text-[13px] text-gray-400 font-inter font-light"><?php echo get_the_date('Y.m.d'); ?></span>
                        </div>
                    </article>
                    <?php
                endwhile;
                ...
                foreach ($dummy_posts as $post) {
                    ...
                    <article class="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 flex flex-col justify-between" data-aos="fade-up">
                        <div class="h-[220px] overflow-hidden relative">
                            <img src="<?php echo esc_url($post['img']); ?>" alt="<?php echo esc_attr($post['title']); ?>" class="w-full h-full object-cover">
                        </div>
                        <div class="p-8 flex-1 flex flex-col justify-between">
                            <div>
                                <span class="text-[12px] font-bold text-[#006eff] uppercase tracking-wider"><?php echo esc_html($post['tag']); ?></span>
                                <h3 class="font-pretendard text-[18px] lg:text-[21px] font-bold text-[#1a1a1a] mt-2 mb-3 line-clamp-2 hover:text-[#006eff] transition-colors">
                                    <a href="<?php echo esc_url(home_url('/insight/')); ?>"><?php echo esc_html($post['title']); ?></a>
                                </h3>
                                <p class="font-pretendard text-gray-500 text-[14px] lg:text-[15px] font-light leading-relaxed line-clamp-3 mb-6">
                                    <?php echo esc_html($post['excerpt']); ?>
                                </p>
                            </div>
                            <span class="block text-[13px] text-gray-400 font-inter font-light"><?php echo esc_html($post['date']); ?></span>
                        </div>
                    </article>
                    <?php
                }
...
<section class="py-20 lg:py-32 bg-[#006eff] relative overflow-hidden text-white text-center">
    <!-- 원형 빛 무늬 효과 -->
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] lg:w-[1000px] h-[600px] lg:h-[1000px] rounded-full bg-white/10 blur-[80px] lg:blur-[120px] pointer-events-none z-0"></div>

    <div class="relative z-10 max-w-[800px] mx-auto px-5">
        <h2 class="font-pretendard text-[28px] lg:text-[48px] font-bold leading-tight tracking-tight mb-6" data-aos="fade-up">
            혼자 고민하지 마세요.<br>이엘이 함께 헤쳐 나갑니다.
        </h2>
        <p class="font-pretendard text-white/80 text-[15px] lg:text-[18px] font-light leading-relaxed mb-10 max-w-[600px] mx-auto" data-aos="fade-up" data-aos-delay="100">
            사건 초기 수사 단계 대처부터 최종 법원 변론까지,<br>법률 전문가들의 즉각적이고 다각적인 대응으로 최선의 결과를 약속드립니다.
        </p>
        <div class="flex flex-col sm:flex-row justify-center gap-4" data-aos="fade-up" data-aos-delay="200">
            <a href="<?php echo esc_url(home_url('/contact/')); ?>" class="inline-flex items-center justify-center gap-2 h-[56px] px-8 bg-white text-[#006eff] text-[16px] font-bold rounded-2xl hover:bg-gray-50 transition-colors duration-200 shadow-xl shadow-[#006eff]/20">
                1:1 온라인 상담 신청
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
            </a>
            <a href="tel:02-872-1307" class="inline-flex items-center justify-center gap-2 h-[56px] px-8 border border-white/30 bg-white/10 text-white text-[16px] font-bold rounded-2xl hover:bg-white/20 transition-colors duration-200 backdrop-blur-sm">
                전화 법률 상담 연결
            </a>
        </div>
    </div>
