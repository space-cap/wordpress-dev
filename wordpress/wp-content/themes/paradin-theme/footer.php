    ...
    <div class="max-w-[1520px] mx-auto px-5 lg:px-10 py-16 lg:py-24">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            ...
            <div class="lg:col-span-1 flex flex-col gap-5">
                <span class="font-lora text-[22px] font-bold tracking-tight">법무법인 파라딘</span>
                ...
                <div
                    ...
                    <p class="font-inter">contact@paradin.com</p>
                    <p>대표변호사: 이영현</p>
                </div>
            </div>
    ...
    <div class="border-t border-white/5">
        <div
            ...
            <p class="text-[13px] text-[#4d4d4d] font-light">
                © 2026 Law Firm PARADIN. All Rights Reserved.
            </p>
...
<div id="float-consult-wrap"
    ...
    <button id="float-consult-btn" aria-label="상담 채널 선택" style="width:58px;height:58px;border-radius:50%;
        ...
        <span style="position:absolute;inset:0;border-radius:50%;
                     ...
                     animation:paradin-pulse 2s ease-out infinite;"></span>
    </button>
</div>

<!-- 펄스 키프레임 -->
<style>
    @keyframes paradin-pulse {
        0% {
            transform: scale(1);
            opacity: 0.7;
        }
