...
function paradin_consultation_details_callback($post)
{
    ...
    <table class="form-table" style="width: 100%;">
        <tr>
            ...
            <td><span
                    style="background: #e0f2fe; color: #0369a1; padding: 4px 10px; border-radius: 4px; font-weight: bold; font-size: 12px;"><?php echo esc_html($type_kr); ?></span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <textarea readonly
                    style="width: 100%; height: 120px; background: #f8fafc; border: 1px solid #cbd5e1; border-radius: 6px; padding: 10px; font-family: inherit; font-size: 13px; line-height: 1.6; resize: none;"><?php echo esc_textarea($message); ?></textarea>
            </td>
        </tr>
    </table>
    <?php
