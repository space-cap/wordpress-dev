    ...
    <div
        ...
        <div
            ...
            <div class="flex flex-wrap justify-center lg:justify-start gap-3 lg:gap-4 mb-8 lg:mb-10" data-aos="fade-up"
                data-aos-delay="200">
                <button
                    class="about-tab active h-[38px] lg:h-[48px] px-6 lg:px-8 rounded-full font-inter text-[13px] lg:text-[15px] font-semibold transition-all duration-300 bg-[#eef4ff] border border-paradin-blue text-paradin-blue shadow-sm"
            ...
            <div class="relative w-[140px] lg:w-[200px] h-[5px] rounded-full overflow-hidden bg-[#e4e4e4]"
                ...
                <div id="about-progress" class="absolute left-0 top-0 h-full bg-paradin-blue transition-all duration-500"
                    style="width: 35%;"></div>
            </div>
        </div>
    ...
    <div class="max-w-[1520px] mx-auto px-5 lg:px-10">
        <div class="text-center mb-16 lg:mb-24" data-aos="fade-up">
            ...
            <p
                ...
                법무법인 파라딘은 풍부한 성공 경험을 바탕으로, 각 센터별 전담 변호사들이 사건 초기부터 합심하여 다각적인 법리 검토를 진행합니다.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div class="lg:col-span-4" data-aos="fade-right">
                ...
                <p class="font-pretendard text-gray-400 text-[15px] lg:text-[16px] leading-relaxed font-light">
                    법무법인 파라딘은 말뿐인 변론이 아닌, 실체적인 판결과 데이터로 차별화된 실력을 입증합니다. 압도적인 결과로 신뢰를 지켜 드립니다.
                </p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div class="bg-gray-50 rounded-[32px] overflow-hidden hover:shadow-2xl hover:shadow-[#006eff]/5 transition-all duration-300 group border border-gray-100"
                ...
                <div class="h-[380px] lg:h-[450px] overflow-hidden relative">
                    <img src="/wp-content/themes/paradin-theme/assets/images/attorney_lee.png" alt="이영현 대표변호사"
                        loading="lazy"
            ...
            <div class="bg-gray-50 rounded-[32px] overflow-hidden hover:shadow-2xl hover:shadow-[#006eff]/5 transition-all duration-300 group border border-gray-100"
                data-aos="fade-up" data-aos-delay="200">
                <div class="h-[380px] lg:h-[450px] overflow-hidden relative">
                    <img src="/wp-content/themes/paradin-theme/assets/images/attorney_park.png" alt="박민서 파트너변호사"
                        loading="lazy"
                        class="w-full h-full object-cover object-top transition-transform duration-500 group-hover:scale-105">
                    <div
                        class="absolute inset-0 bg-gradient-to-t from-black/75 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-8">
            ...
            <div class="bg-gray-50 rounded-[32px] overflow-hidden hover:shadow-2xl hover:shadow-[#006eff]/5 transition-all duration-300 group border border-gray-100"
                data-aos="fade-up" data-aos-delay="300">
                <div class="h-[380px] lg:h-[450px] overflow-hidden relative">
                    <img src="/wp-content/themes/paradin-theme/assets/images/attorney_kim.png" alt="김우진 소송전담변호사"
                        loading="lazy"
                        class="w-full h-full object-cover object-top transition-transform duration-500 group-hover:scale-105">
                    <div
                        class="absolute inset-0 bg-gradient-to-t from-black/75 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 lg:mb-24"
            ...
            <div>
                <span
                    ...
                    & NEWS</span>
                <h2 class="font-pretendard text-[28px] lg:text-[44px] font-bold text-[#1a1a1a] tracking-tight mt-2">파라딘의
                    법률 가이드 & 뉴스</h2>
            </div>
...
<section class="py-20 lg:py-32 bg-[#006eff] relative overflow-hidden text-white text-center">
    ...
    <div class="relative z-10 max-w-[800px] mx-auto px-5">
        <h2 class="font-pretendard text-[28px] lg:text-[48px] font-bold leading-tight tracking-tight mb-6"
            data-aos="fade-up">
            혼자 고민하지 마세요.<br>파라딘이 함께 헤쳐 나갑니다.
        </h2>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        tabs.forEach(tab => {
            tab.addEventListener('click', function () {
                // 모든 탭 스타일 초기화
                tabs.forEach(t => {
                    t.classList.remove('active', 'bg-[#eef4ff]', 'border-paradin-blue', 'text-paradin-blue', 'shadow-sm');
                    t.classList.add('bg-[#f8f8f8]', 'text-[#5f5f5f]');
                });

                // 클릭된 탭 스타일 활성화
                this.classList.add('active', 'bg-[#eef4ff]', 'border-paradin-blue', 'text-paradin-blue', 'shadow-sm');
