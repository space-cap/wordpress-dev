...
<body <?php body_class('bg-white text-black font-pretendard'); ?>>
    ...
    <div id="portfolio-banner"
        ...
        <div
            ...
            <p
                ...
                본 사이트는 법무법인 파라딘의 프로그래머 채용 지원을 위해 커스텀 워드프레스 테마로 직접 제작한 모의 리뉴얼 프로젝트입니다.
    ...
    <script>
        ...
        // ============================================
        (function () {
            var BANNER_KEY = 'paradin_portfolio_banner_closed';
    ...
    <nav id="gnb"
                    ...
                    <li class="relative group">
                        ...
                        <div class="absolute left-1/2 -translate-x-1/2 top-full pt-4 hidden group-hover:block z-50">
                            <ul
                                ...
                                <li><a href="/news/"
                                        class="block px-4 py-2 text-[15px] font-medium text-gray-700 hover:text-paradin-blue hover:bg-[#eef4ff] rounded-lg transition-colors text-center">뉴스</a>
                                </li>
                                <li><a href="/insight/"
                                        class="block px-4 py-2 text-[15px] font-medium text-gray-700 hover:text-paradin-blue hover:bg-[#eef4ff] rounded-lg transition-colors text-center">인사이트</a>
                                </li>
                            </ul>
                        </div>
                    </li>
        ...
        <div id="mobile-menu"
            ...
            <div class="flex justify-between items-center h-[60px] shrink-0">
                <span class="font-lora text-[22px] font-bold text-white">법무법인 파라딘</span>
            ...
            <div class="text-[14px] text-gray-500 font-light shrink-0">
                © 2026 Legal Firm PARADIN. All Rights Reserved.
            </div>
        </div>
    </nav>
